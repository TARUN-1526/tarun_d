    ...
    <section id="home" className="relative min-h-screen flex flex-col justify-center py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 flex flex-col items-center text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/80 border border-emerald-100 mb-12 backdrop-blur-sm animate-float shadow-sm">
          ...
          <span className="text-emerald-700 text-xs font-bold tracking-widest uppercase">Available for Hire</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-5 items-center w-full justify-center">
          ...
          <div className="flex gap-4 items-center">
             <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-[#0077b5] hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md">
               <Linkedin size={20} />
             </a>
             <a href={personalInfo.github} target="_blank" rel="noreferrer" className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-[#333] hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md">
               <Github size={20} />
             </a>
             <a href={`mailto:${personalInfo.email}`} className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-emerald-500 hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md">
               <Mail size={20} />
             </a>

             {/* New: Coding profile links */}
             <a
               href={personalInfo.leetcode}
               target="_blank"
               rel="noreferrer"
               className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-black hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md flex items-center gap-2"
               title="LeetCode"
             >
               {/* LeetCode SVG from simple-icons CDN */}
             ...
             <a
               ...
               target="_blank"
               rel="noreferrer"
               className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-[#2EC866] hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md flex items-center gap-2"
               title="HackerRank"
             >
             ...
             <a
               ...
               target="_blank"
               rel="noreferrer"
               className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-[#F7941E] hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md flex items-center gap-2"
               title="CodeChef"
             >
             ...
             <a
               ...
               target="_blank"
               rel="noreferrer"
               className="p-3 rounded-xl bg-white border border-slate-200 hover:bg-[#00A1E0] hover:text-white hover:border-transparent text-slate-500 transition-all hover:scale-110 shadow-sm hover:shadow-md flex items-center gap-2"
               title="Trailhead"
             >
               {/* Use Salesforce icon (Trailhead logo variant isn't in every icon set) */}
               <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/salesforce.svg" alt="Trailhead / Salesforce" className="w-5 h-5" />
             </a>
          </div>
        </div>
